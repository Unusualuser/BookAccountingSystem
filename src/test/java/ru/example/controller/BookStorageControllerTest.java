...
class BookStorageControllerTest {
    ...
    @DisplayName("JUnit positive test for BookStorageControllerTest addQuantity method")
    @Test
    ...
    @DisplayName("JUnit negative test for BookHistoryControllerTest addQuantity method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit positive test for BookStorageControllerTest reduceQuantity method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit negative test for BookHistoryControllerTest reduceQuantity method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit positive test for BookStorageControllerTest getQuantityByBookId method")
    @Test
    ...
    @DisplayName("JUnit negative test for BookHistoryControllerTest getQuantityByBookId method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
