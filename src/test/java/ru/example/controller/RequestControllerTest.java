...
class RequestControllerTest {
    ...
    @DisplayName("JUnit positive test for RequestControllerTest requestBook method")
    @Test
    ...
    @DisplayName("JUnit negative test for RequestControllerTest requestBook method")
    @Test
    @WithMockUser(username = "user", password = "user", roles = {"USER"})
    ...
    @DisplayName("JUnit positive test for RequestControllerTest getRequestsByBookIdForPeriod method")
    @Test
    ...
    @DisplayName("JUnit negative test for RequestControllerTest getRequestsByBookIdForPeriod method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit positive test for RequestControllerTest getAllRequestsByBookId method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit negative test for RequestControllerTest getAllRequestsByBookId method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
