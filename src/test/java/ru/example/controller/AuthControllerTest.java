...
class AuthControllerTest {
    ...
    @DisplayName("Integration positive test for AuthControllerTest registerUser method")
    @Test
    ...
    @DisplayName("Integration negative test for AuthControllerTest registerUser method")
    @Test
    ...
    @DisplayName("Integration positive test for AuthControllerTest registerModerator method")
    @Test
    ...
    @DisplayName("Integration negative test for AuthControllerTest registerModerator method")
    @Test
    @WithMockUser(username = "admin", password = "admin", roles = {"ADMIN"})
    ...
    @DisplayName("Integration positive test for AuthControllerTest auth method")
    @Test
    ...
    @DisplayName("Integration negative test for AuthControllerTest auth method")
    @Test
