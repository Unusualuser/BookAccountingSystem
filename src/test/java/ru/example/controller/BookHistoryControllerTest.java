...
class BookHistoryControllerTest {
    ...
    @DisplayName("JUnit positive test for BookHistoryControllerTest rentBook method")
    @Test
    ...
    @DisplayName("JUnit negative test for BookHistoryControllerTest rentBook method")
    @Test
    @WithMockUser(username = "user", password = "user", roles = {"USER"})
    ...
    @DisplayName("JUnit positive test for BookHistoryControllerTest returnRentedBook method")
    @Test
    ...
    @DisplayName("JUnit negative test for BookHistoryControllerTest returnRentedBook method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit positive test for BookHistoryControllerTest getFullBookHistoryByBookId method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit negative test for BookHistoryControllerTest getFullBookHistoryByBookId method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit positive test for BookHistoryControllerTest getBookHistoriesByBookIdForPeriod method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit positive test for BookHistoryControllerTest findAndGetExpiredRent method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
