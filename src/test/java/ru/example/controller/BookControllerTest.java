...
class BookControllerTest {
    ...
    @DisplayName("JUnit positive test for BookControllerTest saveBook method")
    @Test
    ...
    @DisplayName("JUnit negative test for BookControllerTest saveBook method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit positive test for BookControllerTest updateBookInfo method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit negative test for BookControllerTest updateBookInfo method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit positive test for BookControllerTest deleteBookById method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit negative test for BookControllerTest deleteBookById method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
    ...
    @DisplayName("JUnit positive test for BookControllerTest getBookById method")
    @Test
    ...
    @DisplayName("JUnit negative test for BookControllerTest getBookById method")
    @Test
    @WithMockUser(username = "user", password = "user", roles = {"USER"})
    ...
    @DisplayName("JUnit positive test for BookControllerTest getAllBooks method")
    @Test
    @WithMockUser(username = "user", password = "user", roles = {"USER"})
