...
class UserControllerTest {
    ...
    @DisplayName("Integration positive test for UserControllerTest updateUserPersonalInfo method")
    @Test
    ...
    @DisplayName("Integration negative test for UserControllerTest updateUserPersonalInfo method")
    @Test
    @WithMockUser(username = "user", password = "user", roles = {"USER"})
    ...
    @DisplayName("Integration positive test for UserControllerTest getUserById method")
    @Test
    ...
    @DisplayName("Integration negative test for UserControllerTest getUserById method")
    @Test
    @WithMockUser(username = "moder", password = "moder", roles = {"MODERATOR"})
