...
INSERT INTO public."user"(user_id, name, address, phone_number, email, login, password, role) VALUES
    (nextval('user_user_id_seq'), 'Анисимов Андрей Андреевич', 'Москва, Ломоносовский проспект, 3', '+79998883344', 'anisimov.andrew.hi@gmail.com', 'andrew', '$2a$10$jHWyDwe6B33hILs1aQfA7uvfXw6QwhvcYbe18dOhQ3Qw1ZNDc363C', 'ROLE_ADMIN'),
    (nextval('user_user_id_seq'), 'Лежебоков Даниил Артурович', 'Москва, Ленинградский проспект, 2', '+79997772255', 'daniil@mail.ru', 'daniil', '$2a$10$Lm43IyJICtgRUM2r7p88HO9VIH9jVq4qu1BhKDcmWWsGNX70TmfVW', 'ROLE_USER'),
    (nextval('user_user_id_seq'), 'Рукастик Олег Борисович', 'Москва, Мичуринский проспект, 1', '+79996661166', 'oleg@mail.ru', 'oleg', '$2a$10$krNjpC0FzvqVc64CDApZsOkKDsVdGFsM0mfvOui8z2MAyHdBlG1u6', 'ROLE_MODERATOR');
